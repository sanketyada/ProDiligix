  ...
  const industries = [
    {
      ...
      title: "IT Industry",
      sub: "Smart sourcing • SLA-backed delivery",
    ...
    },
    {
      ...
      title: "eCommerce",
      sub: "Faster dispatch • Live tracking",
    ...
    },
    {
      ...
      title: "FMCG",
      sub: "Pan-India supply consistency",
    ...
    },
    {
      ...
      sub: "Centralized indirect procurement",
  ...
  const expertise = [
    {
      title: "Shipping and\nreceiving",
      bg: "#6D63F3",
      icon: <PackageCheck className="w-9 h-9 text-white" />,
    },
    {
      title: "FTL and LTL\nfreight shipping",
      bg: "#B36A53",
    ...
    },
    {
      title: "Reverse\nlogistics",
      bg: "#EB5F5E",
      icon: <Undo2 className="w-9 h-9 text-white" />,
    },
    {
      title: "Train & Air\nServices",
      bg: "#0EA5E9",
      icon: (
        <div className="relative">
          ...
          <Plane className="w-4 h-4 text-white absolute -right-2 -top-1 opacity-90" />
        </div>
      ),
    },
    {
      title: "Gifting",
      bg: "#F59E0B",
      icon: <Gift className="w-9 h-9 text-white" />,
    },
    {
      title: "Event\nManagement",
      bg: "#10B981",
  ...
  const howItWorks = [
    {
      title: "Send your\nrequirement",
      color: "#EF4444",
      icon: <FolderUp className="w-8 h-8" />,
    },
    {
      title: "Get\nmultiple quotations",
      color: "#F59E0B",
    ...
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-6 pt-32 md:pt-52 pb-12">
        ...
        <div
          ...
          className="mx-auto w-full bg-white rounded-xl shadow-md p-1 fade-in"
        >
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 md:px-6 pt-6 md:pt-10 pb-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-10 gap-y-12 place-items-center px-2">
          {expertise.map((item, i) => (
            <div
              key={i}
              className="group flex flex-col items-center pop-in"
